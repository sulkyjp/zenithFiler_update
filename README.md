...
| ファイル | 内容 |
|---|---|
| `ZenithFiler_v0.38.9.zip` | **完全版** — .NET ランタイム同梱。初回導入や環境移行に |
| `ZenithFiler_v0.38.9_patch.zip` | **軽量版** — ランタイム除外。既存環境のアップデートに |
| `ZenithFiler_v0.38.9_delta_from_0.38.8.zip` | **差分版** — 前バージョンから変更されたファイルのみ |
<!-- download-table:end -->

> 過去のバージョンは [Releases](https://github.com/sulkyjp/zenithFiler_update/releases) ページから取得できます。

<!-- latest-changes:begin -->
## Latest Changes — [0.38.9] - 2026-03-22 : アップデートタイプ選択

### Added
- **アップデートタイプ選択:** アップデート確認後にダウンロードタイプ（自動選択・差分パッチ・パッチ・フルアップデート）をドロップダウンで選択可能に。各タイプのファイルサイズも併記。新規ファイルが追加されたバージョンでは「フルアップデート」を選択することで確実に全ファイルを取得可能
